...
<section class="shade3 center py-60 curve grow">
    <div class="w-sm col gap-40 h100">
        ...
        <div class="row space-between shade2 curve pa-20">
            <span class="font-24 align-center">Order number</span>
            <span class="weight-600 font-28">3367002</span>
        </div>
        <div class="col space-between shade2 curve pa-20 gap-10">
        ...
        <div class="col gap-5">
            <div class="row space-between shade2 curve pa-20">
                <div class="row gap-20 center">
                    <img class="h-80 w-80 curve" {src} alt="" />
                    <div class="col gap-10">
                        <span class="weight-600">DRILL HOSE FITTING RAINDROP DRL 11CM</span>
                        <span clasrow gap-10s="font-14">Delivery Date: 27/06/2022</span>
                        <span>Quantity: 1</span>
                        <span class="font-14">SKU: 63846</span>
                    </div>
                </div>
                <span>115 THB</span>
            </div>
